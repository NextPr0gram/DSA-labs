...
public class PathFinder {
    ...
    public StackADT<Position> findPath() {
        ...
        while (!found && !reversedPath.isEmpty()) {
             ...
             */
            Position position = reversedPath.peek();
            ...
            if (position.equals(maze.exit())) {
                ...
                List<Position> moves = maze.potentialMovesFrom(position);
                if (moves.isEmpty()) {
                    reversedPath.pop();
                } else {
    ...
    private StackADT<Position> reverse() {
        ...
        StackADT<Position> result = new LinkedStack<>();

        while (!reversedPath.isEmpty()) {
            result.push(reversedPath.pop());
        }
