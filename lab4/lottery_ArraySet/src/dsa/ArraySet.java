...
public class ArraySet<T> extends AbstractSet<T> {
    ...
    /**
     * Copy Constructor: Creates a new ArraySet object from the given ArraySet
     * object.
     * 
     * @param set the given ArraySet object which is to be used to create the new
     *            set
     */
    ...
    private void expandCapacity() {
        ...
        T[] expanded = (T[]) new Object[currentSize * 2];

        for (int i = 0; i < contents.length; i++) {
            expanded[i] = contents[i];
        }
    ...
    public SetADT<T> union(SetADT<T> set) {
        ...
        SetADT<T> union = new ArraySet<>(this);
