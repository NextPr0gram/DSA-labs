...
public interface BinaryTreeADT<T> {
  ...
  /**
   * Returns the inorder traversal result.
   *
   * @return the string representation of an inorder traversal on this binary tree.
   */
   ...
   *
   * @return the string representation of an preorder traversal on this binary tree.
   */
   ...
   *
   * @return the string representation of an postorder traversal on this binary tree.
   */
  public String postOrder();

  /**
   * Returns the level order traversal result.
   *
   * @return the string representation of an levelorder traversal on this binary tree.
   */
